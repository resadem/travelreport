...
import { Search, Download, Plus, Eye, LogOut, Settings as SettingsIcon, Users, Globe } from 'lucide-react';
...
const Dashboard = () => {
  ...
  // Form state for adding reservation
                    ...
                    <form onSubmit={handleAddReservation} className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input value={formData.agency_name} onChange={(e) => setFormData({...formData, agency_name: e.target.value})} required />
                        </div>
                        <div>
                        ...
                        <div className="col-span-2">
                          ...
                          <Input value={formData.tourist_names} onChange={(e) => setFormData({...formData, tourist_names: e.target.value})} required />
                        </div>
                        <div>
