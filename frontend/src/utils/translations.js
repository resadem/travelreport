export const translations = {
  ru: {
    ...
    requests: {
      ...
      status: 'Статус',
      inProgress: 'В работе / Working on',
      booked: 'Забронирована / Booked',
      confirmed: 'Подтверждено / Confirmed',
      cancelled: 'Аннулировано / Canceled',
      awaitingPayment: 'Ожидание оплаты / Waiting payment',
      paid: 'Оплачено / Paid',
      partiallyPaid: 'Частично оплачено / Partly paid',
      notPaid: 'Не оплачено / Not paid',
      documentsReady: 'Документы готовы / Documents Ready',
      documentsNotReady: 'Документы не готовы / Documents Not Ready',
